...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	CAN_FilterTypeDef filter;
	   filter.FilterIdHigh         = 0x123 << 5;                  // ãƒ•ã‚£ãƒ«ã‚¿ãƒ¼ID1
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_SET);   //LEDã‚’ç‚¹ç¯
  }
  /* USER CODE END 3 */
}
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_Output_Pin|GPIO_PIN_6|GPIO_PIN_7, GPIO_PIN_RESET);

  /*Configure GPIO pins : GPIO_Output_Pin PB6 PB7 */
  GPIO_InitStruct.Pin = GPIO_Output_Pin|GPIO_PIN_6|GPIO_PIN_7;
